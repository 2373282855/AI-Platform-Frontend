<template>
  ...
  <el-dialog :model-value="visible" :title="title" :width="width" :center="center" :close-on-click-modal="false"
    :append-to-body="false" draggable :destroy-on-close="destroyOnClose" :before-close="koiClose" :fullscreen="fullscreen"
    :loading="loading" :footer-hidden="footerHidden" :before-close-check="true" style="top: -80px !important; z-index: 9999;">
...
// @ts-ignore
import { MsgWarning, MsgBox, MsgSuccess } from "@/utils/koi.ts";
// 定义参数的类型
interface IDialogProps {
  ...
  beforeCloseCheck?: boolean; // 是否在关闭前进行检查
}
// 子组件接收父组件的值

...
import { NoticeSuccess, koiNoticeWarning, NoticeError } from "@/utils/koi.ts";
...
const handleHttpUpload = async (options: UploadRequestOptions) => {
  ...
  try {
    ...
    const res: any = await axios.post(props.action, formData);
    options.onSuccess(import.meta.env.VITE_SERVER + res.data.file_url);

                                            ...
                                            <div>
                                                <div
                                                    ...
                                                    <el-button type="primary"
                                                        @click="run_script_list()">立即调试</el-button>
                                                </div>
                                        ...
                                        <KoiCard style="height: 20%">
                                            <div>
                                                <el-descriptions title="脚本信息：" column="4">
                                                    ...
                                                    <el-descriptions-item label="脚本名称：">{{ item.name
                                                    }}</el-descriptions-item>
                                                    <el-descriptions-item label="最后更新人： ">{{ item.content.username
                                                    }}</el-descriptions-item>
                                            ...
                                            <div style="padding-block-end: 5px">
                                                <div style="float: right">
                                                    <el-button type="success"
                                                        @click="save_script(item.id)">保存</el-button>
                                                </div>
                                                <div style="float: right; padding-left: 10px; padding-right: 10px">
                                                    <el-button type="primary"
                                                        @click="run_script(item.id)">立即调试</el-button>
                                                </div>
                                                <div style="float: right">
                                            ...
                                            <template #dropdown>
                                                <el-dropdown-menu class="header-new-drop">
                                                    ...
                                                    <el-dropdown-item icon="Edit"
                                                        @click="rename_menu(data)">重命名</el-dropdown-item>
                ...
                <KoiDialog ref="device_koiDialogRef" :title="title" @koi-confirm="run_confirm" @koi-cancel="run_cancel"
                    ...
                    <template #content>
                        <el-form ref="formRef" :model="run_form" label-width="80px" status-icon>
                            ...
                            <el-form-item label="选择设备：" prop="roleCode">
                    ...
                    <template #content>
                        <el-form ref="formRef" :model="run_form" label-width="80px" status-icon>
                            ...
                            <el-form-item label="类型：">
                                <el-radio-group v-model="run_form.run_type">
                                    <el-radio :value="1">普通自动化</el-radio>
                                    <el-radio :label="2">差更包体自动化</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item v-if="run_form.run_type === 2" label="差更版本：" prop="roleCode">
                                <el-input v-model="run_form.version" placeholder="请输入版本号" clearable />
                                            ...
                                            <KoiCard>
                                                <div>
                                                    <el-descriptions column="4">
                                                        <el-descriptions-item label="任务名称：">{{ run_form.task_name
                                                        }}</el-descriptions-item>
                                                        <el-descriptions-item label="设备：">{{ item.name
                                                        }}</el-descriptions-item>
                                                        <el-descriptions-item label="操作系统：">{{ item.os_type
                                                        }}</el-descriptions-item>
                                                        <el-descriptions-item label="系统版本： ">{{ item.version
                                                        }}</el-descriptions-item>
                                                        ...
                                                        <el-descriptions-item v-if="run_type == '正在执行'" label="运行：">
                                                            <el-button type="danger" plain
                                                                @click="stop_run(item.pid)">停止</el-button>
                                                        </el-descriptions-item>
                                                    </el-descriptions>
                                                </div>
                                            </KoiCard>
                                                                    ...
                                                                    <KoiCard :style="get_colors(res.status)">
                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            <el-button icon="Picture" type="text"
                                                                                @click="pre_view(res.before_img)"> 执行前
                                                                            </el-button>
                                                                            <el-button icon="Picture" type="text"
                                                                                @click="pre_view(res.after_img)"> 执行后
                                                                            </el-button>
                                                                ...
                                                                <el-descriptions :column="1">
                                                                    <el-descriptions-item label="手机实时页面：">
                                                                        <el-button type="primary" plain
                                                                            @click="view_phone()">查看手机页面</el-button>
                                                                    </el-descriptions-item>
                                                                    <el-descriptions-item label="是否已修正：">
                                                                        <el-button type="primary" plain
                                                                            @click="run_app_correction()">已修正点击此按钮</el-button>
                                                                    </el-descriptions-item>
                                                                </el-descriptions>
                                                                <el-descriptions column="2">
                                                                    <el-descriptions-item label="脚本总数：">{{ script_total
                                                                    }} 个</el-descriptions-item>
                                                                    <el-descriptions-item label="未执行：">{{ script_un_run
                                                                    }}个</el-descriptions-item>
                                                                </el-descriptions>
                                                                <el-descriptions column="2">
                                                                    <el-descriptions-item label="执行通过：">
                                                                        <el-tag type="success"> {{ script_pass }} 个
                                                                        </el-tag>
                                                                    </el-descriptions-item>
                                                                    <el-descriptions-item label="执行失败：">
                                                                        <el-tag type="danger"> {{ script_fail }} 个
                                                                        </el-tag>
                                                                    </el-descriptions-item>

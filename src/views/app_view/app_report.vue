...
const get_app_result = async () => {
  ...
  const res: any = await get_app_result_detail({
              ...
              <div>
                <koiCard style="width: 33%; float: left; height: 190px">
                  <el-descriptions border :column="1" size="mini">
                    ...
                    <!--                    <el-descriptions-item label="执行时长">{{ res_form.end_time }}</el-descriptions-item>-->
                    <!--                    <el-descriptions-item label="但设备平均时长">{{ res_form.end_time }}</el-descriptions-item>-->
                  </el-descriptions>
                </koiCard>
              </div>
                        ...
                        <div v-for="(device, index) in device_list" :key="index" style="padding-block-end: 10px">
                          <div :style="get_card_style(device.status)" :class="{ highlight: selectedIndex === index }"
                            ...
                            <el-button v-if="device.status === 0"
                              ...
                              circle @click="device_click(device, index)">
                              {{ device.name }}
                            </el-button>
                ...
                <div>
                  <div style="width: 66%; float: left">
                    <el-tabs v-model="log_active" @tab-click="handle_script">
                                ...
                                <KoiCard style="width: 45%; float: left; height: 487px; overflow: auto">
                                  <el-timeline style="width: 90%">
                                    <el-timeline-item center v-for="(res, index) in run_result" :key="index"
                                      ...
                                      size="large" :timestamp="'执行时间：' + res.create_time" placement="top">
                                ...
                                <KoiCard style="width: 50%; float: left; height: 487px; overflow: auto">
                                  ...
                                  <div>
                                    <el-descriptions column="2">
                                      <el-descriptions-item label="脚本总数：">{{ result_form.total }}
                                        个</el-descriptions-item>
                                      <el-descriptions-item label="未执行：">{{ result_form.un_run }}
                                        个</el-descriptions-item>
                                    </el-descriptions>
                                    <el-descriptions column="2">
                                    ...
                                    <el-descriptions column="1">
                                      <el-descriptions-item label="开始时间：">{{ res_form.start_time
                                      }}</el-descriptions-item>
                                      <el-descriptions-item label="结束时间：">{{ result_form.end_time
                                      }}</el-descriptions-item>
                                      <el-descriptions-item v-if="pre_video !== ''" label="视频详情：">
                                        <el-button icon="VideoPlay" type="text"
                                          @click="pre_view_video">查看视频详情</el-button>
                                      </el-descriptions-item>
                                    </el-descriptions>
                                  </div>
                                </KoiCard>
                      ...
                      <el-tab-pane v-for="(item, index) in res_form.script_list" :key="index" :label="item.name"
                        :name="item.id">
                        <div>
                          <KoiCard>
                            <div>
                        ...
                        <div style="padding-top: 5px">
                          <KoiCard style="height: 510px">
                            <div style="width: 100%">
                              <div>
                                <KoiCard style="width: 100%; float: left; height: 487px; overflow: auto">
                                  <el-timeline style="width: 90%">
                                    <el-timeline-item center v-for="(res, index) in run_result" :key="index"
                                      :icon="getIcon(res.status)" type="primary" :color="colors(res.status)"
                                      size="large" :timestamp="'执行时间：' + res.create_time" placement="top">
                  ...
                  <div v-if="log_active === 'first'" style="width: 33%; float: right; padding-top: 50px">
                    <KoiCard style="width: 100%; float: left; height: 587px; overflow: auto">
